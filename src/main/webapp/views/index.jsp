    ...
    <main role="main">
      <article>
        <%
          ...
          if (pageType.equals("index") || (!pageType.equals("sign_up") && !pageType.equals("create_cabinet") && !pageType.equals("add_item") && !pageType.equals("show_items") && !pageType.equals("edit_item"))) {
